...
meta =
{
    ...
    name = "avorion-commands",

    -- Title of your mod that will be displayed to players
    title = "Avorion Commands Package",

    -- Description of your mod that will be displayed to players
    description = "Dummy Text. Avorion doesn't like steam formatting apparently. Somebody ping me to update the actual description.",
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "0.31.2", max = "0.50"}
    },
